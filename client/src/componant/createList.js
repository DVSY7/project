      ...
      <div className="grid grid-cols-1 grid-rows-9 sm:grid-rows-1 sm:grid-cols-sm-minmax sm:grid-cols-9 h-screen overflow-x-hidden">
        ...
        <div className=" flex flex-col flex-wrap bg-green-200 row-span-9 sm:col-span-8 ">
          <div className="flex items-center justify-center w-full h-full">
            <div
              className={`w-[95%] h-[93%] rounded-3xl flex flex-row bg-white`}
            >
              {/* 왼쪽쪽 영역 */}
              <div className="flex-grow-2 grid grid-rows-[1fr_6.5fr_0.5fr] p-4 pl-10">
                {/* 상단 영역 */}
                <div className="flex grid grid-rows-[0.5fr_1fr]">
                  <div className="flex-1 flex items-center justify-between">
                    <div className="text-xl">20xx.MM.DD</div>
                    <div>
                      ...
                      <button className="border px-4 py-0.5 rounded">
                        대면
                      </button>
                    </div>
                  </div>
              ...
              {/* 오른쪽 영역 */}
              <div className="flex-grow-2 bg-blue-100 flex items-center justify-center">
                2
              </div>
            </div>
          </div>
