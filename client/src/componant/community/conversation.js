        ...
        <>
            <div className={`flex ${userName !== currentUserName ? "justify-end" : ""} mt-2`}>
                ...
                <div className={`${userName !== currentUserName ? "order-2" : ""}`}>
                    ...
                    {/* 채팅 내용 */}
                    <div className={`${userName !== currentUserName ? "bg-white" : "bg-[#E0F3FF]"} border-[1px] border-gray-300 border-solid rounded-md p-2 px-3 mx-2 font-bold`}>{message.message}</div>
                </div>
