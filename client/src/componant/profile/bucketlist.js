                        ...
                        <div key={profile.title} className={`flex w-[90%] h-[25%] border-b border-b-gray-200 ml-6`}>
                            ...
                            <div className={`flex flex-col justify-end w-[25%]`}>
                                <div className={`flex justify-between`}>
                                    <span className={`flex justify-center items-center text-[0.7rem] rounded-lg bg-orange-100 w-10 h-4 mt-1`}>{profile.interests}</span>
                                ...
                                <div className={`grid grid-cols-2 font-sans font-bold text-[0.9rem]`}>
                                    ...
                                    <div className={'col-start-2 flex'}>
                                        <span 
                                            className={`flex justify-end text-blue-400 w-full cursor-pointer text-[0.8rem]`}
                                            onClick={()=>{
