                ...
                <div className={`flex relative w-[60vw] h-[75vh] rounded-md bg-white bg-opacity-100`}>
                    ...
                    <div className={`w-[40%] rounded-r-md`}>
                        ...
                        <div className={`h-[32.5%] flex border-b-[2px] border-gray-200`}>
                            ...
                            <div className={`w-[85%]`}>
                                {/* 갤러리 본문 내용 */}
                                <div className={`h-[87%] flex justify-center items-center bg-blue-300`}>
                                    <textarea className="w-full h-[80%]" placeholder="글을 입력하세요"></textarea>
                                </div>
                                {/* 갤러리 본문 태그 */}
                                <div className={`h-[13%]`}>
                        ...
                        <div className={`h-[7.5%] flex`}>
                            {/* 갤러리 댓글 인풋 영역 */}
                            <div className={`resize-none outline-none w-[85%] h-full pt-4 pl-4 `}></div>
                            {/* 갤러리 댓글 게시버튼 */}
                            <div className={`w-[15%] flex justify-center items-center text-blue-500`}>공유하기</div>
                        </div>
                    </div>
                </div>
            </div>
